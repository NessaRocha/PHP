        ...
        <div class="container col-11 col-md-9" id="form-container">
            <div class="row align-items-center ">
                <div class="col-md-6 order-md-2">
                    <h2 class="login">LOGIN ESPECIALISTA:</h2>
                    <form action="metodos/login-especialista.php" method="POST">
                ...
                <div class="col-md-6 order-md-1">
                    <div class="col-12">
                        <img src="assets/img/loginespecialista.svg" height="350px" width="400px" alt=" Entrar na plataforma" class="img-fluid">
                    </div>
                    <div class="col-12" id="link-container">
                        <a class="btn btn-secondary" href="./login-paciente.php" role="button">SOU PACIENTE</a>
                    </div>
                    <!-- Default radio -->
                </div>
            </div>
